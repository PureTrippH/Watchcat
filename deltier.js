exports.run = async (client, message, args) => {
	...
	await removedTierFromUser(client, message, tagged, dbResConfig, dbResStats, userIndex, serverStats, tierIndex);
...
const removedTierFromUser = async(client, message, tagged, dbResConfig, dbResStats, userIndex, serverStats, tierIndex) => {
	console.log("Adding to set");
	if(guildMembers[userIndex].punishmentsTiers[tierIndex].tierLevel == 0) {
