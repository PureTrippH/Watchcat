exports.run = async (client, message, args) => {
  ...
  infoBoard.setFooter(`Laela's Watchcat - Created Jul 23 2020`, "https://images.vexels.com/media/users/3/140908/isolated/preview/bdc30bbe3c022a11e2d7fd0e642c61ae-open-book-icon-by-vexels.png");
    infoBoard.setTimestamp();
    infoBoard.setTitle(`Laela's WatchCat`);
    infoBoard.setAuthor(`Laela's WatchCat`, 'https://lh3.googleusercontent.com/proxy/qATfAOL5i1fYQGxrOQIF8ZIP-CPwZvcISjfpHdYpvDFFfgNkW1MgZN7_5zI84S9rOblRAPCjWVPHHEhV0BrpT0r9WUhsQrSSik8aRvL12gwIEHFQa30OudA2o0g5nylM')
    ...
    infoBoard.addFields(
      ...
      { name: `Server Dashboard -`, value: `Coming Soon`, inline: false },
